...
// definir un jugador ocmo un objeto para sacar un arraylist de tipo jugador que tenga las caracteristicas de all
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Expulsados del continente del este por los humanos y guiados por su lidet Thrall hacia Kalimdor\n" +
                ...
                "esta civilizacion esta hecha para hacer ataques rapidos y destruir a sus enemigos de manera sopresiva");
