    ...
    */
    ...
    public void Jugar(){
        ...
        System.out.println("Bajo los espesos bosques de Ashenvale se encuentran los misteriosos Elfos de la noche \n" +
                ...
                "Rara vez se relacionan con otras razas ya que creen que podrian corromper sus dominios y linaje pero los tiempos han cambiado\n" +
                "y ha llegado la hora de defender sus preciados territorios. Armados con el poder de la luna y arcos bendecidos por esta\n" +
                "estan decididos a vencer a cualquiera que se les interponga todo esto en nombre de su diosa, Elune\n");
        System.out.println("Los Humanos de Lordaeron\n");
        System.out.println("Debilitados por constantes guerras contra sus antiguos enemigos la Orda de los orcos \n" +
                " los humanos no pudieron defenderse de la aplastante invacion de los despiadados muertos vivientes que ls llevo asi \n" +
                " a tener que buscar refugio en los valles del antiguo continente de Kalimdor\n" +
        ...
        System.out.println("Invocados por el necromancer Kel'tuzad escoltado por el principe caido Arthas los muertos tienen un solo objetivo,\n" +
                "arrasar con todo a su paso para preparar la invasion de la legion de fuego, los muertos vivientes no tienen misericordia contra sus enemigos\n" +
                ...
                " es sembrar el terror en sus enemigos por medio de sus armas que utilizan miembros de cadaveres como municion o sus invocaciones de magia profana\n" +
                " ya han conquistado todo el continente del este y solo les queda uno... Kalimdor\n");
        System.out.println("La Orda de los Orcos\n");
        System.out.println("Expulsados del continente del este por los humanos y guiados por su lidet Thrall hacia  el viejo continente de Kalimdor\n" +
                "los orcos, feroces gerreros, despiadados en el campo de batalla y sangrientos mas que nadie se caracterizan\n" +
                "por sus escaramuzas veloces y devastadoras, siempre han sido los primeros en armar su maquinaria belica" +
                "a pesar de eso a la larga sus grandes ejercitos siempre fueron aplastados por pequenos batallones humanos lo que los llevo a su derrota" +
                "fueron tan humillados que los humanos empezaron a conciderarlos una banda de simples ladrones... pero, sera realmente asi?\n");
